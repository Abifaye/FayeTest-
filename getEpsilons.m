function [outputArg1,outputArg2] = getEpsilons
%UNTITLED2 Summary of this function goes here
%% kdist
choosek = input(strcat('Choose k:',32));
load normData.mat
...
kdistminus1 = kdist(2:end,:)';
%all kdist data sorted into column vector
Vdist = sort(kdistminus1(:));
%% LINE 1 and 2
...
epsilon_trial(1:length(pa)) = Vdist(p3(1)+pa(1,:)); %note to self: run DBScanner for all pa x values.NEED TO FIX THIS PART 
